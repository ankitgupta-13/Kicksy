...
import { Input, ProductDescription } from "../../../../../components";
...
const DetailProduct = () => {
  ...
  const getProductId = (isAdmin) => {
    if (isAdmin) {
      return useSelector((state) => state.adminDashboard.currentProduct);
    }
    return useSelector((state) => state.sellerDashboard.currentProduct);
  };
      ...
      {product ? (
        <div style={{ marginTop: "20px" }}>
          ...
          {productRequestID ? (
            ...
            <div
              className={style.editdiv}
              style={{ position: "absolute", top: "75%", right: "3%" }}
            >
            ...
            >
              {!showOffer ? (
                ...
                >
                  <span className={style.edit} color="white">
                    Add Offer
                  </span>
                </button>
              ) : (
