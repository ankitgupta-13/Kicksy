    ...
    <Container>
      ...
      <div className={style.Gender}>
        <div className={style.GenderContainer}>
          <div className={style.GenderBox}><img src={GirlPic1} alt="" /></div>
          <div className={style.GenderBoxTitle}>Women</div>
        </div>
        <div className={style.GenderContainer}>
          <div className={style.GenderBox}><img src={MenPic1} alt="" /></div>
          <div className={style.GenderBoxTitle}>Men</div>
        </div>
        <div className={style.GenderContainer}>
          <div className={style.GenderBox}><img src={KidPic1} alt="" /></div>
      ...
      <div className={style.CompanyContainer}>
        <div className={style.CompanyItemBox}>
          <div className={style.CompanyItem}><img src={JordanLogo} alt="" /></div>
          <div className={style.CompanyItemTitle}>Jordan</div>

        </div>
        <div className={style.CompanyItemBox}>
          <div className={style.CompanyItem}><img src={NikeLogo} alt="" /></div>
          <div className={style.CompanyItemTitle}>Jordan</div>
        </div>
        <div className={style.CompanyItemBox}>
          <div className={style.CompanyItem}><img src={AdidasLogo} alt="" /></div>
          <div className={style.CompanyItemTitle}>Jordan</div>
        </div>
        <div className={style.CompanyItemBox}>
          <div className={style.CompanyItem}><img src={NikeLogo} alt="" /></div>
