...
const FilterSidebar = ({ filters, onFilterChange }) => {
  ...
  const handleGenderButtonClick = (gender) => {
    ...
    if (gender === "M") {
      setMActive(!mActive);
      newFilters = mActive
        ? filters.filter((filter) => filter !== "M")
        : [...filters, "M"];
    } else if (gender === "F") {
      setWActive(!wActive);
      newFilters = wActive
      ...
      setKActive(!kActive);
      newFilters = kActive
        ? filters.filter((filter) => filter !== "K")
        : [...filters, "K"];
    }
  ...
  return (
    <div className={style.filtersidebar}>
      <div className={style.CurrentFiltersContainer}>
        <h4 className={style.CurrentFiltersContainerHeading}>
          Current Filters
        </h4>
        <div>
        ...
        <p
          ...
          style={{
            cursor: "pointer",
            display: filters?.length === 0 ? "none" : "inline-block",
            width: "max-content",
          }}
        >
          Clear All
      ...
      <div className={style.BodyTypeContainer}>
        ...
        <div className={style.buttons}>
          <Button
            ...
            style={{
              backgroundColor: mActive ? "black" : "white",
              color: mActive ? "white" : "black",
              width: "80px",
            }}
          ...
          <Button
            className={style.Button}
            style={{
              backgroundColor: wActive ? "black" : "white",
              color: wActive ? "white" : "black",
              width: "80px",
            }}
          ...
          <Button
            className={style.Button}
            style={{
              backgroundColor: kActive ? "black" : "white",
              color: kActive ? "white" : "black",
              width: "80px",
            }}
