      ...
      <div className={style.footer2}>
        <div className={style.UpperFooterSection}>
          <div className={style.UpperFooterSection1}>
            <div>
              <h1 className={style.UpperFooterSection1Heading1}>Join our</h1>
              <h1 className={style.UpperFooterSection1Heading2}>
                mailing list
              </h1>
            </div>
            <div>
              <p className={style.UpperFooterSectionContent}>
          ...
          <div className={style.UpperFooterSection2}>
            ...
            <div className={style.EmailIcon}>
              <img className={style.RightIcon} src={RightIcon} alt="" />
            </div>
          </div>
        </div>
